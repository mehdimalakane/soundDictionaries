# NVDA 2026.2 Developer Guide

- [NVDA 2026.2 Developer Guide](https://download.nvaccess.org/documentation/developerGuide.html#nvda-20262-developer-guide "NVDA 2026.2 Developer Guide")
  - [Introduction](https://download.nvaccess.org/documentation/developerGuide.html#introduction "Introduction")
    - [Add-on API stability](https://download.nvaccess.org/documentation/developerGuide.html#API "Add-on API stability")
      - [Definition of the public API](https://download.nvaccess.org/documentation/developerGuide.html#definition-of-the-public-api "Definition of the public API")
      - [The API release cycle](https://download.nvaccess.org/documentation/developerGuide.html#the-api-release-cycle "The API release cycle")
      - [Classification of API changes](https://download.nvaccess.org/documentation/developerGuide.html#classification-of-api-changes "Classification of API changes")
        - [Signature breaking changes](https://download.nvaccess.org/documentation/developerGuide.html#signature-breaking-changes "Signature breaking changes")
        - [Behavioural refinements & bug fixes](https://download.nvaccess.org/documentation/developerGuide.html#behavioural-refinements-bug-fixes "Behavioural refinements & bug fixes")
        - [Security improvements](https://download.nvaccess.org/documentation/developerGuide.html#security-improvements "Security improvements")
      - [API deprecation strategy](https://download.nvaccess.org/documentation/developerGuide.html#api-deprecation-strategy "API deprecation strategy")
      - [Stability of transitive imports in the API](https://download.nvaccess.org/documentation/developerGuide.html#APIImports "Stability of transitive imports in the API")
      - [Stability of pip packages](https://download.nvaccess.org/documentation/developerGuide.html#APIIncludedPipPackages "Stability of pip packages")
    - [A Note About Python](https://download.nvaccess.org/documentation/developerGuide.html#aboutPython "A Note About Python")
    - [C++](https://download.nvaccess.org/documentation/developerGuide.html#cPlusPlus "C++")
  - [Translation](https://download.nvaccess.org/documentation/developerGuide.html#translation "Translation")
    - [Character Descriptions](https://download.nvaccess.org/documentation/developerGuide.html#characterDescriptions "Character Descriptions")
      - [Translating this file](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingCharacterDescriptionsFile "Translating this file")
    - [Symbol Pronunciation](https://download.nvaccess.org/documentation/developerGuide.html#symbolPronunciation "Symbol Pronunciation")
      - [Defining Complex Symbols](https://download.nvaccess.org/documentation/developerGuide.html#complexSymbols "Defining Complex Symbols")
      - [Defining Symbol Information](https://download.nvaccess.org/documentation/developerGuide.html#symbolInformation "Defining Symbol Information")
      - [Examples](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingSymbolsExamples "Examples")
      - [Translating this file](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingSymbolsFile "Translating this file")
    - [Gestures](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGestures "Gestures")
      - [Examples](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesExamples "Examples")
        - [Example 1: The original gesture is defined with a character that is not a key name on the locale keyboard layout](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesEx1 "Example 1: The original gesture is defined with a character that is not a key name on the locale keyboard layout")
        - [Example 2: The original gesture takes advantage of the keys physical location](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesEx2 "Example 2: The original gesture takes advantage of the keys physical location")
        - [Example 3: The original gesture is defined to match a native shortcut](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesEx3 "Example 3: The original gesture is defined to match a native shortcut")
      - [How to remap a shortcut key](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesSteps "How to remap a shortcut key")
        - [Identify the class, the script and the original gesture to be remapped](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesStepIdentify "Identify the class, the script and the original gesture to be remapped")
        - [Case of a global command script](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesStepCaseGlobal "Case of a global command script")
        - [Case of an application specific script](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesStepCaseApplication "Case of an application specific script")
        - [Case of an object specific script](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesStepCaseObject "Case of an object specific script")
      - [Translating this file](https://download.nvaccess.org/documentation/developerGuide.html#TranslatingGesturesFile "Translating this file")
  - [Plugins](https://download.nvaccess.org/documentation/developerGuide.html#plugins "Plugins")
    - [Overview](https://download.nvaccess.org/documentation/developerGuide.html#pluginsOverview "Overview")
    - [Types of Plugins](https://download.nvaccess.org/documentation/developerGuide.html#pluginsTypes "Types of Plugins")
    - [Basics of an App Module](https://download.nvaccess.org/documentation/developerGuide.html#appModuleBasics "Basics of an App Module")
    - [Associating App Modules with an executable](https://download.nvaccess.org/documentation/developerGuide.html#AssociatingAppModule "Associating App Modules with an executable")
    - [Example 1: An App Module that Beeps on Focus Change Events](https://download.nvaccess.org/documentation/developerGuide.html#Example1 "Example 1: An App Module that Beeps on Focus Change Events")
    - [App modules for hosted apps](https://download.nvaccess.org/documentation/developerGuide.html#appModulesForHostedApps "App modules for hosted apps")
    - [Example 2: an app module for an app hosted by wwahost.exe](https://download.nvaccess.org/documentation/developerGuide.html#example2 "Example 2: an app module for an app hosted by wwahost.exe")
    - [Example 3: an app module for an app employing Edge WebView2 (msedgewebview2.exe)](https://download.nvaccess.org/documentation/developerGuide.html#example3 "Example 3: an app module for an app employing Edge WebView2 (msedgewebview2.exe)")
    - [Basics of a Global Plugin](https://download.nvaccess.org/documentation/developerGuide.html#globalPluginBasics "Basics of a Global Plugin")
    - [Example 3: a Global Plugin Providing a Script to Announce the NVDA Version](https://download.nvaccess.org/documentation/developerGuide.html#example3 "Example 3: a Global Plugin Providing a Script to Announce the NVDA Version")
    - [NVDA Objects](https://download.nvaccess.org/documentation/developerGuide.html#NVDAObjects "NVDA Objects")
    - [Scripts and Gesture Bindings](https://download.nvaccess.org/documentation/developerGuide.html#scripts "Scripts and Gesture Bindings")
      - [Defining script properties](https://download.nvaccess.org/documentation/developerGuide.html#DefiningScriptProperties "Defining script properties")
    - [Example 4: A Global Plugin to Find out Window Class and Control ID](https://download.nvaccess.org/documentation/developerGuide.html#example4 "Example 4: A Global Plugin to Find out Window Class and Control ID")
    - [Events](https://download.nvaccess.org/documentation/developerGuide.html#events "Events")
    - [the App Module SleepMode variable](https://download.nvaccess.org/documentation/developerGuide.html#appModuleSleepMode "the App Module SleepMode variable")
    - [Example 5: A Sleep Mode App Module](https://download.nvaccess.org/documentation/developerGuide.html#example5 "Example 5: A Sleep Mode App Module")
    - [Providing Custom NVDA Object Classes](https://download.nvaccess.org/documentation/developerGuide.html#customNVDAObjectClasses "Providing Custom NVDA Object Classes")
    - [Example 6: Command to Retrieve the Length of Text in an Edit Field Using a Custom NVDA Object](https://download.nvaccess.org/documentation/developerGuide.html#example6 "Example 6: Command to Retrieve the Length of Text in an Edit Field Using a Custom NVDA Object")
    - [Making Small Changes to an NVDA Object in App Modules](https://download.nvaccess.org/documentation/developerGuide.html#smallChangesToNVDAObjectInAppModules "Making Small Changes to an NVDA Object in App Modules")
    - [Example 7: Labelling the Notepad Edit Field Using event\_NVDAObject\_init](https://download.nvaccess.org/documentation/developerGuide.html#example7 "Example 7: Labelling the Notepad Edit Field Using event_NVDAObject_init")
    - [Parsing additional command line arguments in your plugin](https://download.nvaccess.org/documentation/developerGuide.html#PluginCLIArgs "Parsing additional command line arguments in your plugin")
  - [Packaging Code as NVDA Add-ons](https://download.nvaccess.org/documentation/developerGuide.html#Addons "Packaging Code as NVDA Add-ons")
    - [Non-ASCII File Names in Zip Archives](https://download.nvaccess.org/documentation/developerGuide.html#nonASCIIFileNamesInZip "Non-ASCII File Names in Zip Archives")
    - [Manifest Files](https://download.nvaccess.org/documentation/developerGuide.html#manifest "Manifest Files")
      - [Available Fields](https://download.nvaccess.org/documentation/developerGuide.html#manifestFields "Available Fields")
      - [An Example Manifest File](https://download.nvaccess.org/documentation/developerGuide.html#manifestExample "An Example Manifest File")
    - [Plugins and Drivers](https://download.nvaccess.org/documentation/developerGuide.html#pluginsAndDrivers "Plugins and Drivers")
    - [Optional install / Uninstall code](https://download.nvaccess.org/documentation/developerGuide.html#installUninstallCode "Optional install / Uninstall code")
      - [the onInstall function](https://download.nvaccess.org/documentation/developerGuide.html#onInstall "the onInstall function")
      - [The onUninstall Function](https://download.nvaccess.org/documentation/developerGuide.html#onUninstall "The onUninstall Function")
    - [Localizing Add-ons](https://download.nvaccess.org/documentation/developerGuide.html#localizingAddons "Localizing Add-ons")
      - [Locale-specific Manifest Files](https://download.nvaccess.org/documentation/developerGuide.html#localeManifest "Locale-specific Manifest Files")
      - [Locale-specific Messages](https://download.nvaccess.org/documentation/developerGuide.html#localeMessages "Locale-specific Messages")
      - [Symbol dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSymbolDictionaries "Symbol dictionaries")
    - [Speech dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSpeechDictionaries "Speech dictionaries")
      - [Creating speech dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonCreatingSpeechDictionaries "Creating speech dictionaries")
        - [Examples](https://download.nvaccess.org/documentation/developerGuide.html#examples "Examples")
    - [Add-on Documentation](https://download.nvaccess.org/documentation/developerGuide.html#AddonDoc "Add-on Documentation")
    - [Braille translation tables](https://download.nvaccess.org/documentation/developerGuide.html#BrailleTables "Braille translation tables")
  - [NVDA Python Console](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsole "NVDA Python Console")
    - [Usage](https://download.nvaccess.org/documentation/developerGuide.html#pythonConsoleUsage "Usage")
    - [Namespace](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsoleNamespace "Namespace")
      - [Automatic Imports](https://download.nvaccess.org/documentation/developerGuide.html#pythonConsoleAutoImports "Automatic Imports")
      - [Snapshot Variables](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsoleSnapshotVariables "Snapshot Variables")
    - [Tab completion](https://download.nvaccess.org/documentation/developerGuide.html#pythonConsoleTab "Tab completion")
  - [Remote Python Console](https://download.nvaccess.org/documentation/developerGuide.html#remotePythonConsole "Remote Python Console")
    - [Usage](https://download.nvaccess.org/documentation/developerGuide.html#remotePythonConsoleUsage "Usage")
  - [Extension Points](https://download.nvaccess.org/documentation/developerGuide.html#ExtensionPoints "Extension Points")
    - [braille](https://download.nvaccess.org/documentation/developerGuide.html#brailleExtPts "braille")
    - [appModuleHandler](https://download.nvaccess.org/documentation/developerGuide.html#appModuleHandlerExtPts "appModuleHandler")
    - [addonHandler](https://download.nvaccess.org/documentation/developerGuide.html#addonHandlerExtPts "addonHandler")
    - [brailleViewer](https://download.nvaccess.org/documentation/developerGuide.html#brailleViewerExtPts "brailleViewer")
    - [config](https://download.nvaccess.org/documentation/developerGuide.html#configExtPts "config")
    - [core](https://download.nvaccess.org/documentation/developerGuide.html#coreExtPts "core")
    - [inputCore](https://download.nvaccess.org/documentation/developerGuide.html#inputCoreExtPts "inputCore")
    - [logHandler](https://download.nvaccess.org/documentation/developerGuide.html#logHandlerExtPts "logHandler")
    - [nvwave](https://download.nvaccess.org/documentation/developerGuide.html#nvwaveExtPts "nvwave")
    - [speech](https://download.nvaccess.org/documentation/developerGuide.html#speechExtPts "speech")
    - [synthDriverHandler](https://download.nvaccess.org/documentation/developerGuide.html#synthDriverHandlerExtPts "synthDriverHandler")
    - [tones](https://download.nvaccess.org/documentation/developerGuide.html#tonesExtPts "tones")
    - [treeInterceptorHandler](https://download.nvaccess.org/documentation/developerGuide.html#treeInterceptorHandlerExtPts "treeInterceptorHandler")
    - [utils.security](https://download.nvaccess.org/documentation/developerGuide.html#utils_securityExtPts "utils.security")
    - [winAPI.\_displayTracking](https://download.nvaccess.org/documentation/developerGuide.html#winAPI_displayTrackingExtPts "winAPI._displayTracking")
    - [winAPI.messageWindow](https://download.nvaccess.org/documentation/developerGuide.html#winAPI_messageWindowExtPts "winAPI.messageWindow")
    - [winAPI.secureDesktop](https://download.nvaccess.org/documentation/developerGuide.html#winAPI_secureDesktopExtPts "winAPI.secureDesktop")
    - [bdDetect](https://download.nvaccess.org/documentation/developerGuide.html#bdDetectExtPts "bdDetect")
    - [vision.visionHandlerExtensionPoints.EventExtensionPoints](https://download.nvaccess.org/documentation/developerGuide.html#visionExtPts "vision.visionHandlerExtensionPoints.EventExtensionPoints")
  - [Communicating with the user](https://download.nvaccess.org/documentation/developerGuide.html#communicating-with-the-user "Communicating with the user")
    - [The message dialog API](https://download.nvaccess.org/documentation/developerGuide.html#the-message-dialog-api "The message dialog API")
      - [Fallback actions](https://download.nvaccess.org/documentation/developerGuide.html#fallback-actions "Fallback actions")
      - [A note on threading](https://download.nvaccess.org/documentation/developerGuide.html#a-note-on-threading "A note on threading")
      - [Buttons](https://download.nvaccess.org/documentation/developerGuide.html#buttons "Buttons")
      - [Callbacks](https://download.nvaccess.org/documentation/developerGuide.html#callbacks "Callbacks")
      - [Convenience methods](https://download.nvaccess.org/documentation/developerGuide.html#convenience-methods "Convenience methods")
...
2. All API breaking changes will be listed in the "Changes for Developers" section of the What's New document, and the [NVDA Add-on API Announcements](https://groups.google.com/a/nvaccess.org/g/nvda-api "NVDA Add-on API Announcements") email group.
...
Documentation and other resources related to the Python language can be found at [www.python.org/](https://www.python.org/ "www.python.org/")
...
[nvdaHelper readme](https://github.com/nvaccess/nvda/blob/master/nvdaHelper/readme.md "nvdaHelper readme")
...
For complete documentation about translating NVDA, please see the [Translating page](https://github.com/nvaccess/nvda/blob/master/projectDocs/translating/readme.md "Translating page")
...
Translation of `characterDescriptions.dic` happens via [Pull Request to NVDA](https://github.com/nvaccess/nvda/blob/master/projectDocs/translating/github.md "Pull Request to NVDA").

For a full example and reference, please look at [the English `characterDescriptions.dic` file](https://github.com/nvaccess/nvda/blob/master/source/locale/en/characterDescriptions.dic "the English characterDescriptions.dic file").
...
The file contains two sections, [complex symbols](https://download.nvaccess.org/documentation/developerGuide.html#complexSymbols "complex symbols") and [symbols](https://download.nvaccess.org/documentation/developerGuide.html#symbolInformation "symbols").
...
Translation of `symbols.dic` happens via [Pull Request to NVDA](https://github.com/nvaccess/nvda/blob/master/projectDocs/translating/github.md "Pull Request to NVDA").

See the file [locale\\en\\symbols.dic](https://github.com/nvaccess/nvda/blob/master/source/locale/en/symbols.dic "locale\en\symbols.dic") for the English definitions which are inherited for all locales.
...
Translation of `gestures.ini` happens via [Pull Request to NVDA](https://github.com/nvaccess/nvda/blob/master/projectDocs/translating/github.md "Pull Request to NVDA").
...
Please refer to the [Add-ons section](https://download.nvaccess.org/documentation/developerGuide.html#Addons "Add-ons section") later on in this document.
...
To map a single App Module for multiple executables, or handle when an executable name violates the Python import rules, refer to [Associating App Modules with an executable](https://download.nvaccess.org/documentation/developerGuide.html#AssociatingAppModule "Associating App Modules with an executable").
...
For example to map the App Module named "time\_app\_mod" to the "time" executable the plugin may be written as follows:
...
In this example, it defines one event method for gainFocus events (event\_gainFocus), which plays a short beep each time it is executed.
...
The most important part is the class itself.
More information about scripts and the script decorator can be found in the [Defining script properties](https://download.nvaccess.org/documentation/developerGuide.html#DefiningScriptProperties "Defining script properties") section of this guide.
...
- Most events that plugins receive take an argument which is the NVDA Object on which the event occurred.
  For example, event\_gainFocus takes the NVDA Object that represents the control gaining focus.
...
- category: The category of the script in order for it to be grouped with other similar scripts.
   ...
   There are constants for common categories prefixed with SCRCAT\_ in the inputCore and globalCommands modules, which can also be specified.
...
For example, a special "\_\_gestures" Python dictionary can be defined as a class variable on an App Module, Global Plugin or NVDA Object.
This dictionary should contain gesture identifier strings pointing to the name of the requested script, without the "script\_" prefix.
...
For an example of an event handled by an App Module, please refer to [example 1](https://download.nvaccess.org/documentation/developerGuide.html#Example1 "example 1") (focus beeps in notepad).
...
### Example 7: Labelling the Notepad Edit Field Using event\_NVDAObject\_init
...
However, if you want to use any additional arguments, this is possible by adding a handler to the [extension point](https://download.nvaccess.org/documentation/developerGuide.html#ExtensionPoints "extension point")`addonHandler.isCLIParamKnown`.
...
[7-Zip](http://www.7-zip.org/ "7-Zip") supports this, though it must be enabled by specifying the "cu=on" method parameter.
...
- docFileName (string): The name of the main documentation file for this add-on; e.g. readme.html. See the [Add-on Documentation](https://download.nvaccess.org/documentation/developerGuide.html#AddonDoc "Add-on Documentation") section for more details.
- minimumNVDAVersion (string, required): The minimum required version of NVDA for this add-on to be installed or enabled.
  ...
  - This must match a valid API version to be submitted to the Add-on Store.
    Valid API versions are found [on GitHub](https://github.com/nvaccess/addon-datastore-transform/blob/main/nvdaAPIVersions.json "on GitHub").
...
Please refer to the [speech dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSpeechDictionaries "speech dictionaries"), [symbol dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSymbolDictionaries "symbol dictionaries") and [braille translation tables](https://download.nvaccess.org/documentation/developerGuide.html#BrailleTables "braille translation tables") sections.
...
- [Speech dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSpeechDictionaries "Speech dictionaries"): Place them in the `speechDicts` directory with a file name with the `.dic` extension, e.g. `speechDicts\pronunciation.dic`.
- [Symbol dictionaries](https://download.nvaccess.org/documentation/developerGuide.html#AddonSymbolDictionaries "Symbol dictionaries"): Place them in the directory for one or more [locales](https://download.nvaccess.org/documentation/developerGuide.html#localizingAddons "locales") with a file name of `symbols-<name>.dic`, e.g. `locale\en\symbols-greek.dic`.
- [Braille translation tables](https://download.nvaccess.org/documentation/developerGuide.html#BrailleTables "Braille translation tables"): Place them in a `brailleTables` directory in the archive.
...
This directory should contain directories for each language it supports, using the same language code format as the rest of NVDA; e.g. en for English, fr\_CA for French Canadian.
...
For more information about gettext and NVDA translation in general, please read the [Translating NVDA page](https://github.com/nvaccess/nvda/blob/master/projectDocs/translating/readme.md "Translating NVDA page")

#### Symbol dictionaries

You can provide custom speech symbol dictionaries in add-ons to improve symbol pronunciation.
The process to create custom speech symbol dictionaries is very similar to that of the [translation process of existing symbols](https://download.nvaccess.org/documentation/developerGuide.html#symbolPronunciation "translation process of existing symbols").
Note that [complex symbols](https://download.nvaccess.org/documentation/developerGuide.html#complexSymbols "complex symbols") are not supported.
...
Note that for the display name of the symbol dictionary to be translated, an entry should be added to a [locale manifest](https://download.nvaccess.org/documentation/developerGuide.html#localeManifest "locale manifest").
...
Note that for the display name of the dictionary to be translated, an entry should be added to a [locale manifest](https://download.nvaccess.org/documentation/developerGuide.html#localeManifest "locale manifest").
For example, add the following to `locale\fr\manifest.ini`:
...
For more information on speech dictionaries, refer to the [User Guide](https://download.nvaccess.org/documentation/userGuide.html#SpeechDictionaries "User Guide").
...
Although NVDA ships with more than a hundred braille translation tables provided by [the liblouis project](https://liblouis.io/ "the liblouis project") aimed at fitting most needs, it also supports the addition of custom tables.
...
Note that for the display name of the table to be translated, an entry should be added to a [locale manifest](https://download.nvaccess.org/documentation/developerGuide.html#localeManifest "locale manifest").
For example, add the following to `locale\fr\manifest.ini`:
...
Please refer to the [liblouis documentation](https://liblouis.io/documentation/ "liblouis documentation") for detailed information regarding the braille translation tables format.
...
- By pressing NVDA+control+z.
  ...
  See [Snapshot Variables](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsoleSnapshotVariables "Snapshot Variables") for more details.
...
Similarly, if the input is "nav.\_\_", attribute names with two leading underscores are proposed.
...
It is similar to the [local Python console](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsole "local Python console") discussed above, but is accessed via TCP.
...
The namespace is the same as [the namespace in the local Python console](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsoleNamespace "the namespace in the local Python console").

There are some special functions:

- snap(): Takes a snapshot of the current state of NVDA and saves it in the [snapshot variables](https://download.nvaccess.org/documentation/developerGuide.html#PythonConsoleSnapshotVariables "snapshot variables").
...
| Type | Extension Point | Description |
| --- | --- | --- |
| `AccumulatingDecider` | `isCLIParamKnown` | Allows adding NVDA commandline parameters which apply to plugins. See [this section of the Dev Guide](https://download.nvaccess.org/documentation/developerGuide.html#PluginCLIArgs "this section of the Dev Guide") for more information. |
